...
class App(tk.Tk):
    ...
    def _setup(self):
        ...
        self.tgMirFoldIn_value = tk.IntVar()
        self.tgMirFoldOut_value = tk.IntVar()
        ...
        self.tgMirFoldIn = tk.Checkbutton(self.tabWelcomeLeaving)
        self.tgMirFoldIn.place(x=120, y=280, height=24, width=40)
        self.tgMirFoldIn.configure(activebackground="#d9d9d9")
        self.tgMirFoldIn.configure(activeforeground="#000000")
        self.tgMirFoldIn.configure(background="#d9d9d9")
        self.tgMirFoldIn.bind('<ButtonRelease-1>', lambda e: self.after(1, self.tgMirFoldIn_click))
        self.tgMirFoldIn.configure(disabledforeground="#a3a3a3")
        self.tgMirFoldIn.configure(foreground="#000000")
        self.tgMirFoldIn.configure(highlightbackground="#d9d9d9")
        self.tgMirFoldIn.configure(highlightcolor="black")
        self.tgMirFoldIn.configure(indicatoron="0")
        self.tgMirFoldIn.configure(justify='left')
        self.tgMirFoldIn.configure(selectcolor="#d9d9d9")
        self.tgMirFoldIn.configure(text='''In''')
        self.tgMirFoldIn.configure(variable=self.tgMirFoldIn_value)

        self.tgMirFoldOut = tk.Checkbutton(self.tabWelcomeLeaving)
        self.tgMirFoldOut.place(x=165, y=280, height=24, width=40)
        self.tgMirFoldOut.configure(activebackground="#d9d9d9")
        self.tgMirFoldOut.configure(activeforeground="#000000")
        self.tgMirFoldOut.configure(background="#d9d9d9")
        self.tgMirFoldOut.bind('<ButtonRelease-1>', lambda e: self.after(1, self.tgMirFoldOut_click))
        self.tgMirFoldOut.configure(disabledforeground="#a3a3a3")
        self.tgMirFoldOut.configure(foreground="#000000")
        self.tgMirFoldOut.configure(highlightbackground="#d9d9d9")
        self.tgMirFoldOut.configure(highlightcolor="black")
        self.tgMirFoldOut.configure(indicatoron="0")
        self.tgMirFoldOut.configure(justify='left')
        self.tgMirFoldOut.configure(selectcolor="#d9d9d9")
        self.tgMirFoldOut.configure(text='''Out''')
        self.tgMirFoldOut.configure(variable=self.tgMirFoldOut_value)
        ...
        self.btnImportSettings = tk.Button(self.tabCommands)
        ...
        self.btnImportSettings.bind('<ButtonRelease-1>', lambda e: self.after(1, self.btnImportSettings_click))
        ...
        self.btnExportSettings = tk.Button(self.tabCommands)
        ...
        self.btnExportSettings.bind('<ButtonRelease-1>', lambda e: self.after(1, self.btnExportSettings_click))
    ...
    def _window_resize(self, event):
        ...
        # self.geometry("835x485+341+107")
        if self.width_old != self.winfo_width() or self.height_old != self.winfo_height():
    ...
    def _lbLog_add(self, text, color='#00ff00'):
        timestamp = ''
    ...
    def lbLog_add(self, text, color='#00ff00'):
        ...
        for line in text.split('\n'):
            ...
            self.event_queue.put((self._lbLog_add, ('%s' % line, color)))
    ...
    def serial_reading_ibus(self):
        ...
        if self._calculate_checksum(self.serial_rx_buffer[:msg_len + 2]) == 0:
            ...
            self.lbLog_add(' '.join(['%02X' % i for i in self.serial_rx_buffer]))
    ...
    def btnDrl_click(self):
        ...
        if self.tgDrl_value.get():
            value = setbit(value, 0, self.tgDrlParkFront_value.get())
            value = setbit(value, 1, self.tgDrlFogFront_value.get())
            value = setbit(value, 2, self.tgDrlParkTail_value.get())
    ...
    def btnF2P_click(self):
        ...
        if self.tgF2P_value.get():
            value = setbit(value, 0, self.tgF2PLow_value.get())
            value = setbit(value, 1, self.tgF2PFogFront_value.get())
            value = setbit(value, 2, self.tgF2PSeq_value.get())
    ...
    def btnLightBeam_click(self):
        ...
        value = 0
        value = setbit(value, 0, self.tgLightBeamLow_value.get())
        value = setbit(value, 1, self.tgLightBeamHigh_value.get())
    ...
    def btnLightOther_click(self):
        ...
        value = 0
        value = setbit(value, 0, self.tgLightOtherFogFront_value.get())
        value = setbit(value, 1, self.tgLightOtherLicence_value.get())
        value = setbit(value, 2, self.tgLightOtherReverse_value.get())
        value = setbit(value, 3, self.tgLightOtherBrake_value.get())
        value = setbit(value, 4, self.tgLightOtherAmbient_value.get())
        value = setbit(value, 5, self.tgLightOtherFogBack_value.get())
    ...
    def btnLightPark_click(self):
        ...
        value = 0
        value = setbit(value, 0, self.tgLightParkFront_value.get())
        value = setbit(value, 1, self.tgLightParkBack_value.get())
        value = setbit(value, 2, self.tgLightParkBackInside_value.get())
    ...
    def btnLightTurn_click(self):
        ...
        value = 0
        value = setbit(value, 0, self.tgLightTurnFront_value.get())
        value = setbit(value, 1, self.tgLightTurnBack_value.get())
        value = setbit(value, 2, self.tgLightTurnSide_value.get())
    ...
    def btnMirFold_click(self):
        ...
        value = 0
        value = setbit(value, 0, self.tgMirFoldIn_value.get())
        value = setbit(value, 1, self.tgMirFoldOut_value.get())

        if self.avr_mode.get() == 0:
            self.txtSend_set('SET:MIR_FOLD:%s' % value)
        else:
            self.txtSend_set('FB LL FA 09 05 %02X CK' % value)

    def tgMirFoldIn_click(self):
        debug_print('AVR_IBus_Settings.tgMirFoldIn_click')

    def tgMirFoldOut_click(self):
        debug_print('AVR_IBus_Settings.tgMirFoldOut_click')
    ...
    def btnReset_click(self):
        ...
        # self.after(1, _btnReset_click, self)
    ...
    def btnRxTx_click(self):
        ...
        value = setbit(value, 0, self.tgRxTxRx_value.get())
        value = setbit(value, 1, self.tgRxTxTx_value.get())
    ...
    def btnHexSelect_click(self):
        ...
        if self.firmware_signature == MEM_PARTS_328PB['signature']['value']:
            # hex_file = easygui.fileopenbox('Choose HexFile', AVR_IBUS_TITLE, default='AVR_IBus_NANO*.hex', filetypes=['AVR_IBus_NANO*.hex'])
            ...
            # hex_file = easygui.fileopenbox('Choose HexFile', AVR_IBUS_TITLE, default='AVR_IBus_MEGA*.hex', filetypes=['AVR_IBus_MEGA*.hex'])
            name = filedialog.askopenfilename(title="Select file", filetypes=(("hex files", 'AVR_IBus_MEGA*.hex'), ("all files", "*.*")))  # initialdir = "/",
        else:
            name = ''
        debug_print(name)
    ...
    def btnReqs_click(self):
        ...
        value = 0xFF
        value = setbit(value, 0, self.tgReqsGmState_value.get())
        value = setbit(value, 1, self.tgReqsLcmDim_value.get())
    ...
    def btnUnlock_click(self):
        ...
        value = 0
        value = setbit(value, 0, self.tgUnlockDoor_value.get())
        value = setbit(value, 1, self.tgUnlockBrake_value.get())
        value = setbit(value, 2, self.tgUnlockGearP_value.get())
        value = setbit(value, 3, self.tgUnlockIgn1_value.get())
    ...
    def btnWelLight_click(self):
        ...
        if self.tgWelLight_value.get():
            ...
            value = setbit(value, 0, self.tgWelLightCancelKeyIn_value.get())
            value = setbit(value, 1, self.tgWelLightCancelDoor_value.get())
            value = setbit(value, 2, self.tgWelLightCancelIgn1_value.get())
    ...
    def btnLightSeq_click(self):
        ...
        if self.tgLightSeq_value.get():
            value = setbit(value, 0, self.tgLightSeq_value.get())
            value = setbit(value, 1, self.tgLightSeqWel_value.get())
            value = setbit(value, 2, self.tgLightSeqLev_value.get())
    ...
    def configuration_set(self, setting, value):
        ...
        if setting == 1: # CDC EMU
            ...
            value = int(value)
            self.tgWelLightCancelKeyIn_value.set(getbit(value, 0))
            self.tgWelLightCancelDoor_value.set(getbit(value, 1))
            self.tgWelLightCancelIgn1_value.set(getbit(value, 2))
            self._tgWelLightCancel_set()
        ...
        elif setting == 5: # MIR_FOLD
            value = int(value)
            self.tgMirFoldIn_value.set(getbit(value, 0))
            self.tgMirFoldOut_value.set(getbit(value, 1))
            ...
            if value > 0:
                ...
                if value != 4:
                    self.tgF2PLow_value.set(getbit(value, 0))
                    self.tgF2PFogFront_value.set(getbit(value, 1))
            ...
            value = int(value)
            self.tgLightParkFront_value.set(getbit(value, 0))
            self.tgLightParkBack_value.set(getbit(value, 1))
            self.tgLightParkBackInside_value.set(getbit(value, 2))
        elif setting == 10: # LIGHT_BEAM
            value = int(value)
            self.tgLightBeamLow_value.set(getbit(value, 0))
            self.tgLightBeamHigh_value.set(getbit(value, 1))
        elif setting == 11: # LIGHT_OTHER
            value = int(value)
            self.tgLightOtherFogFront_value.set(getbit(value, 0))
            self.tgLightOtherLicence_value.set(getbit(value, 1))
            self.tgLightOtherReverse_value.set(getbit(value, 2))
            self.tgLightOtherBrake_value.set(getbit(value, 3))
            self.tgLightOtherAmbient_value.set(getbit(value, 4))
            self.tgLightOtherFogBack_value.set(getbit(value, 5))
        elif setting == 12: # LIGHT_SEQUENZ
            value = int(value)
            self.tgLightSeq_value.set(getbit(value, 0))
            self.tgLightSeqWel_value.set(getbit(value, 1))
            self.tgLightSeqLev_value.set(getbit(value, 2))
            pass
        elif setting == 13: # LIGHT_TURN
            value = int(value)
            self.tgLightTurnFront_value.set(getbit(value, 0))
            self.tgLightTurnBack_value.set(getbit(value, 1))
            self.tgLightTurnSide_value.set(getbit(value, 2))
            ...
            value = int(value)
            self.tgRxTxRx_value.set(getbit(value, 0))
            self.tgRxTxTx_value.set(getbit(value, 1))
            ...
            if value > 0:
                ...
                self.tgDrlParkFront_value.set(getbit(value, 0))
                self.tgDrlFogFront_value.set(getbit(value, 1))
                self.tgDrlParkTail_value.set(getbit(value, 2))
            else:
            ...
            value = int(value)
            self.tgUnlockDoor_value.set(getbit(value, 0))
            self.tgUnlockBrake_value.set(getbit(value, 1))
            self.tgUnlockGearP_value.set(getbit(value, 2))
            self.tgUnlockIgn1_value.set(getbit(value, 3))
            ...
            value = int(value)
            self.tgReqsGmState_value.set(getbit(value, 0))
            self.tgReqsLcmDim_value.set(getbit(value, 1))
        elif setting == 40:
    ...
    def configuration_import(self):
        ...
        self.tgMirFoldIn_value.set(ini_read(cfg_file, 'SETTINGS', 'MIR_FOLD_IN', False))
        self.tgMirFoldOut_value.set(ini_read(cfg_file, 'SETTINGS', 'MIR_FOLD_OUT', False))
    ...
    def configuration_export(self):
        ...
        ini_write(cfg_file, 'SETTINGS', 'MIR_FOLD_IN', 'true' if self.tgMirFoldIn_value.get() else 'false')
        ini_write(cfg_file, 'SETTINGS', 'MIR_FOLD_OUT', 'true' if self.tgMirFoldOut_value.get() else 'false')
    ...
    def firmware_read(self, size):
        ...
        while read < size:
            ...
            debug_print("serialread: {!r} ({})".format(ret, size - read))
            if ret == "":
                raise Exception("no data read, timeout?")
    ...
    def firmware_upload(self):
        ...
        try:
            ...
            #self.firmwareStatus_set('Error during Upload. Try again.')
...
def invertbit(value, pos):
    bit_value = getbit(value, pos)
    value = setbit(value, pos, not bit_value)
    return value
